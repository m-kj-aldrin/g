...
class Vec3 {
    ...
    transform(matrix) {
        if (matrix instanceof Mat3) {
            ...
            const tX =
                e[0] * this.x + e[4] * this.y + e[8] * this.z + e[12] * 1;
            const tY =
                e[1] * this.x + e[5] * this.y + e[9] * this.z + e[13] * 1;
            const tZ =
                e[2] * this.x + e[6] * this.y + e[10] * this.z + e[14] * 1;
            const tW =
                e[3] * this.x + e[7] * this.y + e[11] * this.z + e[15] * 1;
